...
#ifndef BRAM_CONTROLLER_PROJECT_WRITE_MEMCPY_TEST_HPP
#define BRAM_CONTROLLER_PROJECT_WRITE_MEMCPY_TEST_HPP
...
#endif //BRAM_CONTROLLER_PROJECT_WRITE_MEMCPY_TEST_HPP
